...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons">note_add</i> ویرایش مرخصی
        </li>
    </ol>
@endsection
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="from" class="form-control" name="from" value="{{ CustomDateTime::toJalali($leave->from) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="to" class="form-control" name="to" value="{{ CustomDateTime::toJalali($leave->to) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="days" class="form-control" name="days" value="{{ $leave->days }}">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select id="type" class="form-control show-tick" name="type" data-live-search="true">
                                        ...
                                        @foreach(\App\Nedsa\Constants::LEAVE_TYPE as $leaveType)
                                            <option value="{{ $leaveType['code']}}" {{ $leaveType['code'] == $leave->type ? 'selected' : '' }}>
                                                {{ $leaveType['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
