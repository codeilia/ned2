...
@section('title', 'لیست خرید های مشتری')
...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons rtlIcon">shopping_cart</i> لیست خرید های مشتری
        </li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @slot('title')
            لیست خرید های مشتری ( {{$customer->first_name . ' ' . $customer->last_name}})
            @endslot
