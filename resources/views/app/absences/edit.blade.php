...
@section('title', 'ویرایش غیبت سرباز')
...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons">note_add</i> ویرایش غیبت سرباز
        </li>
    </ol>
@endsection
                            ...
                            <div class="row" style="margin-top: 2rem;">
                                <div class="col-md-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="days" class="form-control" name="days" value="{{ $absence->days }}">
