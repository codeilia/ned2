...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons">playlist_add</i> ثبت کسری
        </li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-10 col-sm-12 col-xs-12">
            ...
            @slot('body')
            <form action="{{ route('shortages.store') }}" method="post">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" id="letter_number" class="form-control" name="letter_number" value="{{ old('letter_number') }}">
