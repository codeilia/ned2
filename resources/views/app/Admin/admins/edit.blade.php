...
@section('title', 'ویرایش اطلاعات مدیر')
...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons">playlist_add</i> ویرایش اطلاعات مدیر
        </li>
    </ol>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-10 col-sm-12 col-xs-12">
            ...
            @slot('body')
            <form action="{{ route('admin.admins.update', ['admin' => $admin->id]) }}" method="post">
                {{ csrf_field() }}
                {{method_field('PUT')}}

                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="username" class="form-control" name="username" value="{{ $admin->username }}">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="personal_code" class="form-control" name="personal_code" value="{{ $admin->personal_code }}">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="first_name" class="form-control" name="first_name" value="{{ $admin->details->first_name }}">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="last_name" class="form-control" name="last_name" value="{{ $admin->details->last_name }}">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="father_name" class="form-control" name="father_name" value="{{ $admin->details->father_name }}">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        <input type="text" id="national_code" class="form-control" name="national_code" value="{{ $admin->details->national_code }}">
