...
@section('content-heading')
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="material-icons rtlIcon">insert_chart</i>آمار شعبه
        </li>
    </ol>
@endsection
...
@section('content')
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="table table-striped text-center ">
                ...
                <tr>
                    ...
                    <td class="text-center" id="purchaseAmount">{{ $branch->saleStat->purchase_amount }}</td>
                    <td class="text-center" id="sellingAmount">{{ $branch->saleStat->selling_amount }}</td>
                    <td class="text-center" id="profit">{{ $branch->saleStat->profit }}</td>
                </tr>
                </tbody>
            </table>
            ...
            <h4>آمار تک تک کانترها</h4>
            <table class="table table-striped text-center ">
                <thead>
                <tr>
                    <th class="text-center">کد پرسنلی کانتر</th>
                    <th class="text-center">نام و نام خانوادگی کانتر</th>
                    <th class="text-center">مبلغ کل خرید</th>
                    <th class="text-center">مبلغ کل فروش</th>
                    <th class="text-center">مبلغ کل حاشیه سود</th>
                </tr>
                ...
                @foreach($branch->counters as $counter)
                    <tr>
                        <td class="text-center">
                            {{ $counter->personal_code }}
                        </td>
                        <td class="text-center">
                            {{ $counter->details->first_name }} {{ $counter->details->last_name }}
                        </td>
                        <td class="text-center" id="purchaseAmount">
                            {{ $counter->saleStat->purchase_amount }}
                        </td>
                        <td class="text-center" id="sellingAmount">
                            {{ $counter->saleStat->selling_amount }}
                        </td>
                        <td class="text-center" id="profit">
                            {{ $counter->saleStat->profit }}
                        </td>
                    </tr>
                @endforeach
                </tbody>
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2> نمودار آمار فروش شعبه {{$branch->name}}</h2>
                </div>
                <div class="body">
