		...
		tooltips: {
			...
			callbacks: {
				...
				label: function(tooltipItem, data) {
                    ...
                    return Persian_Number(data.labels[tooltipItem.index] + ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index]);
...
module.exports = function(Chart) {
	...
	function createTooltipItem(element) {
		...
		return {
			xLabel: Persian_Number(xScale ? xScale.getLabelForIndex(index, datasetIndex)+"" : '' ),
			yLabel: Persian_Number(yScale ? yScale.getLabelForIndex(index, datasetIndex)+"" : ''),
			index: index,
	...
	var DatasetScale = Chart.Scale.extend({
		...
		*/
		getLabels: function() {
			...
			return (this.isHorizontal() ? data.xLabels : data.xLabels) || data.labels;
		},
